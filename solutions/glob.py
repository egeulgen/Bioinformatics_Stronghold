...
def global_alignment(str1, str2):
    str1 = "-" + str1
    str2 = "-" + str2
    ...
    for i in range(1, len(str2)):
        for j in range(1, len(str1)):
            ...
            score2 = score_mat[j - 1][i] - 5
            score3 = score_mat[j][i - 1] - 5
...
if __name__ == "__main__":
    ...
    score, aligned_strA, aligned_strB = global_alignment(stringA, stringB)
